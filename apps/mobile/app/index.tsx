...
export default function CaptureScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
        ...
        {preflight.payload ? (
          <>
            ...
            <View style={styles.chipRow}>
              {renderProviderChip("Mongo", preflight.payload.providers.mongodb.configured, preflight.payload.providers.mongodb.available)}
      ...
      <Pressable
        style={styles.galleryNavRow}
        onPress={() => {
          if (activeRide?.id) {
            router.push({ pathname: "/gallery", params: { rideId: activeRide.id } });
          } else {
            router.push("/gallery");
          }
        }}
      >
        <Text style={styles.galleryNavTitle}>Saved clips</Text>
        <Text style={styles.galleryNavHint}>Open video gallery (MongoDB-backed events when configured)</Text>
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  galleryNavTitle: { fontFamily: "monospace", fontSize: 12, letterSpacing: 2, color: "#fcd34d", fontWeight: "700" },
  galleryNavHint: { marginTop: 6, fontSize: 12, color: "#94a3b8", lineHeight: 18 },
